...
const Notification = () => {
  ...
  const fetchNotifications = async () => {
    try {
      ...
      const invitationsResponse = await axios.get(`${BaseURL}/invitations/pending`, {
        headers: getAuthHeader(),
        withCredentials: true,
      });
  ...
  const handleAcceptInvitation = async (invitationId) => {
    try {
      await axios.put(`${BaseURL}/invitations/${invitationId}/accept`, {}, {
        headers: getAuthHeader(),
        withCredentials: true,
      });
  ...
  const handleRejectInvitation = async (invitationId) => {
    try {
      await axios.put(`${BaseURL}/invitations/${invitationId}/reject`, {}, {
        headers: getAuthHeader(),
        withCredentials: true,
      });
